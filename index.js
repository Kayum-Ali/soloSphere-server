...
const corsOptions = {
  origin: [
    'http://localhost:5173',
    'http://localhost:5174',
    'https://solosphere-d8c6e.web.app/',
  ],
  credentials: true,
...
const uri = "mongodb+srv://SoloSphere2:Atddu4wRUChpNAoQ@cluster0.dangeag.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
  try {
    const jobsCollection = client.db('soloSphrere').collection('jobs')
    const bidsCollection = client.db('soloSphrere').collection('bids')
